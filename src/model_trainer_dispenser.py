...
# nano-dispenser plate placement
#
# To run call:
# $ python model_trainer_dispenser.py path/to/data/folder/
#
# Author: Arnold Teo
# Version: 2023-04-21
...
img_ch = 3
base_dense = 4096
batch_sz = 32       # change the batch size depending on how much data there is
lr = 1e-5
momen=0.9
epoch_num = 50
