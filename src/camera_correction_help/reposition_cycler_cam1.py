...
sandberg_id1 = '\\\\?\\USB#VID_1BCF&PID_28C4&MI_00#7&17f36d47&0&0000#{e5323777-f976-4f5b-9b55-b94699c46e44}\\GLOBAL'

connected_cameras = asyncio.run(get_camera_info())
cam_ids = [camera.id for camera in connected_cameras]  

sandberg_index1 = 99
if sandberg_id1 in cam_ids:
    sandberg_index1 = cam_ids.index(sandberg_id1)

cap = cv2.VideoCapture(sandberg_index1)
...
# read in images
file_old = 'cycler1_reference.png'
