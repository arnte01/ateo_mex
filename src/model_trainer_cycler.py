...
#
# To run call:
# $ python model_trainer_cycler.py path/to/data/folder/
#
# Author: Arnold Teo
# Version: 2023-04-21
...
img_ch = 3
base_dense = 4096
batch_sz = 100      # change the batch size depending on how much data there is
lr = 1e-5           
momen=0.9
epoch_num = 50
...
hidden_layer = Dense(base_dense, activation = 'relu')(in_layer)
dropout_layer = Dropout(0.5)(hidden_layer)
hidden_layer_2 = Dense(base_dense//2, activation = 'relu')(dropout_layer)
dropout_layer_2 = Dropout(0.5)(hidden_layer_2)
out_layer = Dense(4, activation = 'softmax')(dropout_layer_2)
